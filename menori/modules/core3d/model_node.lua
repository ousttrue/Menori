...
---@field super Node
---@field material Material Own copy of the Material that is bound to the model.
---@field mesh Mesh The menori.Mesh object that is bound to the model.
---@field color vec4 Model color. (Deprecated)
...
---@param material Material? [opt=Material.default] menori.Material material object. (A new copy will be created for the material)
...
---@param scene Scene object that is used when drawing the model
---@param environment Environment object that is used when drawing the model
