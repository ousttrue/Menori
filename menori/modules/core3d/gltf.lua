...
---@field wrapS love.WrapMode
---@field wrapT love.WrapMode
...
---@field name string
---@field main_texture LoaderTexture
...
---@field mode any
---@field vertexformat any
---@field vertices table
---@field indices table
---@field indices_tsize integer
---@field material_index integer
---@field count integer

---@class LoaderMesh
---@field name string
---@field primitives LoaderPrimitive[]

---@class LoaderSkin
---@field inverse_bind_matrices table<number[]>
...
---@class TypedBufferData
---@field data love.Data
---@field offset integer
---@field length integer
---@field stride integer
---@field component_size integer 1,2,4
---@field component_type integer char,short,int
---@field type string "VEC2", "VEC3"...
...
---@param v integer
---@return array|ffi.array temp_data
...
---@parameter glb_data string
---@return table json chunk
---@return love.Data[] bin chunks
